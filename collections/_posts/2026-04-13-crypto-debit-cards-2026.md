...
**Smart contract risk.** The architecture runs on Gnosis Safe smart contracts settling on Scroll L2. The [Bybit breach in February 2025 — a ~$1.5 billion loss](https://www.bbc.com/news/articles/cpwyrd81j8go) — was executed through a Safe{Wallet} front-end compromise, the same framework ether.fi relies on. Different implementation, same attack surface category.
...
The effects have been blunt. Coinbase Europe [delisted USDT for EEA users in December 2024](https://www.coindesk.com/policy/2024/12/13/coinbase-to-delist-usdt-and-5-other-stablecoins-for-eu-users-by-end-of-year). Crypto.com [began restricting non-MiCA-compliant stablecoins in the EEA in early 2025](https://crypto.com/en/eea/product-news/updates-crypto-com-exchange-eea-users). Binance took a more targeted path, [restricting non-compliant stablecoins (including USDT) for EEA users through 2025 rather than a full global delisting](https://www.binance.com/en/support/announcement/detail/b9bf4aeaf1a6435ea635ebab734d54bb). Meanwhile, Circle achieved MiCA compliance in July 2024, and USDC transaction volume in Europe jumped sharply through the first half of 2025. Tether has no plans to seek MiCA authorization.
