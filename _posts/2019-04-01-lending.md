...
### <a href="{{ lending.product-url }}">{{ lending.product-title }}</a>{% if lending.ecosystem == 'ethereum' %} ![](images/ether.png "Built on Ethereum or related to Ethereum ecosystem"){% endif %}{% if lending.type == 'non-custodial' %}<i class="fas fa-user-lock" title="Non-custodial"></i>{% endif %}
