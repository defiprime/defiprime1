...
url: /crypto-debit-cards-2026.html
...
I've been using the March 2026 leaderboard from Obchakevich Research as a starting point — one of the more granular on-chain datasets publicly available for this market, though like any Dune dashboard, it reflects the labeling and query assumptions of its authors. The dataset itself has limitations that change how you should interpret almost every number I'm about to cite. So let's start there.
...
How many of those are being reported? No one has a clean number. The cited estimates are anecdotal and methodologically rough: CNN reported an IRS internal review estimating only about [25% voluntary compliance](https://www.cnn.com/2025/11/14/business/taxes-crypto-irs-form-1099-da) among crypto investors; Awaken Tax founder Andrew Duca put it at under 20% in a [February 2026 CoinDesk interview](https://www.coindesk.com/business/2026/02/18/american-crypto-holders-are-scared-and-confused-about-this-year-s-new-irs-tax-rules). Treat these as practitioner estimates, not official statistics. A [CoinTracker/Coinbase survey](https://www.cointracker.io/2026-crypto-tax-report) of 3,000 US crypto users published in April 2026 found 65% had previously reported crypto on their taxes, but that's a self-selected population of Coinbase users who opted into a tax compliance survey, about as representative as asking gym members whether they exercise.
...
In the US, the same dynamic plays out differently. Form 1099-DA, the IRS's new digital asset reporting form, rolls out in phases under the [final broker regulations published July 2024](https://www.irs.gov/newsroom/final-regulations-and-related-irs-guidance-for-reporting-by-brokers-on-sales-and-exchanges-of-digital-assets): custodial brokers track gross proceeds for sales on or after January 1, 2025 (first 1099-DAs filed in early 2026), with cost-basis reporting phasing in for covered transactions from January 1, 2026. Implementation is still settling — issuers have flagged operational gaps, and some requirements remain under guidance. But here's the gap that matters for cards: crypto card issuers that operate offshore and don't qualify as US brokers may not file 1099-DAs at all. A RedotPay card funded by USDT from a non-custodial wallet, used to buy groceries in Miami, currently sits in a reporting gray zone. The user owes taxes. The IRS just has limited visibility into the transaction.
...
Vietnam, ranked among the world's highest in crypto adoption, taxed crypto only indirectly through general income and business frameworks until its Law on Digital Technology Industry — the first legislation to treat digital assets as a distinct category — took effect January 2026. Even now, enforcement infrastructure barely exists. The Philippines taxes crypto gains under general income tax rules; the Bureau of Internal Revenue has moved toward crypto-specific reporting but has not publicly announced a firm CARF participation date, and Southeast Asian peers are broadly expected in later CARF waves rather than the 2027 first wave. Thailand approved a five-year capital gains tax exemption for crypto sold through licensed platforms, running through 2029, effectively making compliant crypto spending tax-free. Nigeria enacted new crypto tax law in mid-2025 with rates up to 25% on digital asset gains, but stablecoins function as the primary savings vehicle for millions of Nigerians escaping naira inflation, and P2P habits built during the 2021-2023 banking ban still dominate over formal exchange use. Brazil requires reporting on crypto sales above BRL 30,000/month and is phasing in a VASP authorization regime through 2026, but 90% of its crypto activity is stablecoin-related according to the central bank, much of it in cross-border corridors that remain hard to trace.

The pattern across these markets: the laws are formalizing, but enforcement lags years behind legislation, and stablecoin spending at the point of sale through an offshore card sits in a gray zone that most tax authorities don't yet have the tools or mandate to monitor. CARF will eventually create cross-border information sharing, but the [first exchanges between the ~48 early-adopter jurisdictions are scheduled for 2027](https://www.oecd.org/en/topics/sub-issues/crypto-asset-reporting-framework.html) (covering 2026 data), and the markets where crypto card adoption is highest (Philippines, Vietnam, Nigeria) are not in that first group — they'll join in later waves, likely 2028 or beyond.
...
The [GENIUS Act](https://www.congress.gov/bill/119th-congress/senate-bill/1582) — signed into law in July 2025 as the first US federal framework for payment stablecoins — requires permitted issuers to comply with Bank Secrecy Act obligations and maintain AML/sanctions programs, with implementation still being written by the OCC, FDIC, Treasury, and FinCEN through 2026. The EU's DAC8 obligations began kicking in from January 1, 2026 (with first reporting in 2027), and the OECD's CARF is on a parallel timeline — first exchanges in 2027 covering 2026 data. The IRS is receiving 1099-DAs from custodial brokers for the first filing cycle. These are real developments, even if each is still mid-rollout. But they primarily affect the US and EU, which are probably not where most of the $607M in monthly volume originates.
...
The product model is simple: load stablecoins, spend via Visa at [130M+ merchant locations globally](https://usa.visa.com/about-visa.html), auto-convert at the point of sale. But the fee structure tells a more nuanced story. RedotPay charges 1% on every crypto-to-fiat conversion, 1.2% FX markup on non-USD transactions, $100 for a physical card ($10 virtual), and 2-3% on ATM withdrawals. Those stack. A foreign ATM withdrawal can cost 3.2% total. And the custodial model means your stablecoins sit in their app, not your wallet.
...
**Smart contract risk.** The architecture runs on Gnosis Safe smart contracts settling on Scroll L2. The [Bybit breach in February 2025 — a ~$1.5 billion loss](https://www.chainalysis.com/blog/bybit-exchange-hack-february-2025-crypto-security-dprk/) — was executed through a Safe{Wallet} front-end compromise, the same framework ether.fi relies on. Different implementation, same attack surface category.
...
**In the US: the [GENIUS Act](https://www.whitehouse.gov/fact-sheets/2025/07/fact-sheet-president-donald-j-trump-signs-genius-act-into-law/).** Signed into law by President Trump in July 2025, this is the first federal payment-stablecoin framework. Since then, the OCC, FDIC, Treasury, and FinCEN have been working through rulemaking — not all at the same pace, and not all finalized. The statute gives regulators 18 months to issue implementing rules, with enforcement staged to begin in 2027. Treat the specific rule-by-rule timeline below as the direction of travel, not locked calendar dates: OCC proposed implementation rules, FDIC has moved on its framework, Treasury is drafting state-level regime equivalency rules, and FinCEN/OFAC are working joint AML/sanctions guidance. Final regulations are expected during 2026, with enforcement beginning January 2027.
...
The effects have been blunt. Coinbase Europe [delisted USDT and five other stablecoins for EEA users in December 2024](https://decrypt.co/296453/coinbase-europe-delists-usdt). Crypto.com [delisted USDT and nine other tokens in the EU by January 31, 2025](https://www.dlnews.com/articles/regulation/cryptocom-to-delist-tether-usdt-in-eu/). Binance took a more targeted path, [restricting non-compliant stablecoins (including USDT) for EEA users through 2025 rather than a full global delisting](https://www.binance.com/en/support/announcement/detail/b9bf4aeaf1a6435ea635ebab734d54bb). Meanwhile, Circle achieved MiCA compliance in July 2024, and USDC transaction volume in Europe jumped sharply through the first half of 2025. Tether has no plans to seek MiCA authorization.
...
**Smart contract risk (ether.fi, Cypher, GnosisPay, Avici, ExaApp, Moonwell):** your assets sit in smart contracts. Industry hack losses in 2025 ran into the billions — [Chainalysis tracked roughly $2.2B in stolen funds](https://www.chainalysis.com/blog/crypto-hacking-stolen-funds-2025/), and other trackers (TRM Labs, Elliptic) report higher figures depending on methodology; all of them put 2025 among the worst years on record, largely driven by the Bybit hit. The Bybit breach itself was executed through a Safe{Wallet} front-end compromise. Security experts say on-chain code is getting harder to exploit directly, but the attack surface has shifted toward operational infrastructure: compromised signers, social engineering, supply-chain attacks. An audit is necessary, not sufficient.
