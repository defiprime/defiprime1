...
url: /tranched-credit-markets.html
...
[DeFi outstanding loans](/decentralized-lending) grew 37% in 2025, mostly driven by [RWA tokenization](/assets-tokenization) and institutional demand for yield, and in 2026 the conversation has shifted toward scalable models incorporating AI-driven credit scoring, cross-chain interoperability, and programmable collateral.

## Who's building on EVM chains

EVM chains, meaning [Ethereum](/ethereum) and L2s like [Arbitrum](/arbitrum), Optimism, and Polygon, are where most of this work lives. The composability helps, and institutions are more comfortable here. Here's a quick-reference breakdown of the protocols worth knowing, followed by some context on how they cluster together.
...
These protocols fall into a few clusters. On the undercollateralized lending side, [Goldfinch](https://goldfinch.finance/) has been at it the longest, making loans to emerging markets. [TrueFi](/product/truefi) takes a similar approach, though growth has stalled. [Maple Finance](/product/maple) pivoted to overcollateralized lending after its 2022 difficulties and is probably getting the most institutional attention of the group right now, with outstanding loans growing eightfold in 2025 and TVL passing \$4B by year-end. Separately, Apollo Global Management signed a deal in February 2026 to acquire up to 90M [MORPHO](/product/morpho) governance tokens over 48 months, a sign that major asset managers are building direct stakes in DeFi lending infrastructure.

The RWA tokenization cluster is led by [Centrifuge](/product/centrifuge), which migrated to an EVM-native architecture in 2025 and now operates across 8 chains including Ethereum, Base, Arbitrum, and Solana. They've distributed over \$1.3B in tokenized assets according to [RWA.xyz](https://www.rwa.xyz/). Pareto Credit is working a similar angle through structured vaults on top of Morpho. Then there are the yield-tranching protocols: BarnBridge across multiple L2s, [Idle Finance](/product/idle) experimenting with AI agents, and Strata Protocol doing dynamic splits with [Pendle](/product/pendle). Lotus Protocol is newer but worth watching for its on-chain ratings approach and RedStone oracle integration.
...
[Solana's](/solana) speed and low fees make it appealing for DeFi broadly, but tranched markets are less mature here. DeFi TVL is approaching $10B (down from a September 2025 all-time high above $12B), with RWAs and private credit among the growing segments.
...
Solana's 2026 roadmap matters for this space because Alpenglow (faster consensus) and Firedancer (execution integrity) should help tranched markets handle stress better. [Kamino](/product/kamino-finance) and [Marginfi](/product/marginfi) already offer modular lending, but explicit tranching is still ramping up. J.P. Morgan issuing commercial paper on Solana is a signal worth noting. That said, the ecosystem is still absorbing lessons from security incidents, most notably Step Finance's ~\$29-40M breach (estimates vary) in January 2026 that led to their permanent shutdown, a reminder that newer ecosystems carry real risk.
...
On a practical level, tranche tokens being tradable and composable helps with liquidity, and regulatory clarity in 2026 is making banks more comfortable participating, especially around programmable [stablecoins](/stablecoins) and cross-border flows. Because everything runs on-chain, the payment waterfalls and default mechanics are visible to anyone who cares to look. Some protocols are already running AI agents that approve loans in under 200ms, which would have been science fiction in DeFi even a year ago.
