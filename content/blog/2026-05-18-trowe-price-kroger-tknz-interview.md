...
git-date:
layout: blog
title: "T. Rowe Price's Crypto Analyst on Why Tokenization's 2026 Win Is Access, Not Efficiency"
url: /trowe-price-kroger-tknz-interview.html
h1title: "T. Rowe's Kroger: Tokenization's Real 2026 Win Is Access"
pagetitle: "T. Rowe Price's Crypto Analyst on Why Tokenization's 2026 Win Is Access, Not Efficiency"
metadescription: "T. Rowe Price's David Kroger on why the cost-savings story for tokenization is overhyped, what's actually onboarding TradFi capital, and the vault-vs-ETF condition for 2031."
category: blog
featured-image: /images/blog/trowe-price-kroger-tknz-interview-ogp.png
intro: "T. Rowe Price's David Kroger on why the cost-savings story for tokenization is overhyped, what's actually onboarding TradFi capital, and the vault-vs-ETF condition for 2031."
author: sawinyh
tags: ["Analysis", "RWAs"]
---
...
Kroger is the internal valuation analyst whose work underwrites asset selection on T. Rowe's [pending TKNZ Active Crypto ETF](https://www.theblock.co/bitcoin-etf-live-chart/393838/t-rowe-price-active-crypto-etf-tknz). T. Rowe CIO Justin Thomson has [publicly credited him for adapting a traditional discounted cash flow framework to use staking rewards as the cash flow input](https://www.troweprice.com/personal-investing/resources/insights/big-questions-bitcoin-investors-have.html). His background is data science before equity research: Loup Ventures under Gene Munster, CBDC work at Piper Sandler, the Ethereum Merge desk at Cowen, then StoneX, then T. Rowe. The customer-facing voices on the firm's digital assets work are Head of Digital Assets Blue Macellari and Global Head of Trading Strategy Matt Howell; Kroger is the bench seat.
...
That matches what the largest tokenized money market funds look like in practice. [BlackRock's BUIDL sat at roughly $2.85B in February 2026](https://www.bloomberg.com/news/articles/2025-04-08/blackrock-adds-anchorage-digital-as-crypto-custodian) and now runs across eight chains, with the majority of AUM on chains other than Ethereum. Franklin's BENJI is at ~$1.98B across nine chains, with over $211M of cumulative peer-to-peer transfer volume per [RWA.xyz](https://app.rwa.xyz/) data. WisdomTree's WTGXX got SEC approval for 24/7 trading in February 2026. The tokenized MMF category sat at roughly $8.6B in November 2025, up around 110% year-over-year.
...
The interview took place while the Senate Banking Committee was approaching its markup of the [CLARITY Act](/clarity-act-anchorage-wysocki). Polymarket's odds on 2026 passage had jumped into the high-40s percent range over the prior week. Kroger's read tracked the optimism.
...
The "assuming it goes through" is the live variable, and it's the same one [Anchorage's Kevin Wysocki was tracking the week before](/clarity-act-anchorage-wysocki).
